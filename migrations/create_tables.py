...
async def main():
    ...
    try:
        ...
        async with connection:  # Check and open connection if not opened yet
            async with connection.transaction():  # Open transaction
                async with connection.cursor() as cursor:  # Get cursor
